    ...
    <table>
        ...
        <tbody>
            ...
            <div style="display:none" class="data-table userDetailsTable">
                ...
                <div>
   <form method="post" action="Amessage" style="display: flex; flex-direction: column; gap: 10px; width: 300px;">
    ...
    <table>
        ...
        <tbody>
            <% 
                List<String[]> driver_messages = (List<String[]>) request.getAttribute("driver_messages");
                if (driver_messages != null && !driver_messages.isEmpty()) {
                    for (String[] Message : driver_messages) {
            %>
                <tr>
    ...
    <table>
        ...
        <tbody>
            <% 
                List<String[]> contactMessages = (List<String[]>) request.getAttribute("contact_messages");
                if (contactMessages != null && !contactMessages.isEmpty()) {
                    for (String[] contactMessage : contactMessages) {
            %>
                <tr>
                    <% for (String value : contactMessage) { %>
                        <td><%= value != null ? value : "N/A" %></td>
                    <% } %>
                </tr>
            <% 
